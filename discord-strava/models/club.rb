class Club
  ...
  def handle_not_found_error(e)
    ...
    logger.error e
    dm! 'Your club can no longer be found on Strava. Please disconnect and reconnect it via /strada clubs.'
    raise e
  end
  ...
  def handle_strava_error(e)
    ...
    when /Authorization Error/
      reset_access_tokens!
      dm! 'There was an authorization problem. Please reconnect the club via /strada clubs.'
    end
    raise e
  end
end
